...
//        poslednje kolone javljaju dugmici edit, add, delete ali zbog prirode reda neki
//        dugmici se vide a neki ne.
...
//        Na kraju programa ugasite pretrazivac.
        ...
        for (int i = 0; i <5 ; i++) {
            ...
            driver.findElement(By.name("name")).sendKeys("Djomlex");
            driver.findElement(By.name("department")).sendKeys("Degustacija");
            driver.findElement(By.name("phone")).sendKeys("225-883");
